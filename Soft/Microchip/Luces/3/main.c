...
#define LUZ0 57 // Para modulo 3
#define LUZ1 58 // Para modulo 3
#define LUZ2 59 // Para modulo 3
#define LUZ3 60 // Para modulo 3
#define LUZ4 61 // Para modulo 3
#define LUZ5 62 // Para modulo 3
#define LUZ6 63 // Para modulo 3
#define LUZ7 64 // Para modulo 3
#define LUZ8 65 // Para modulo 3
#define LUZ9 66 // Para modulo 3
#define LUZ10 67 // Para modulo 3
#define LUZ11 68 // Para modulo 3
...
//LuzEstado[2]=90; // Sensor del Hall
} // si no es 90 (no esta encendida con intensidad)
else {
BusData(LUZ2,80);
//printf("%c%c%c%c", 250, LUZ2, 80, LUZ2 + 80); //APAGO
//LuzEstado[2]=80; // Sensor del Hall
} //Else
} // If
} // While
Retraso = 0;
...
//LuzEstado[3]=90; // Sensor Estar
} // si no es 90 (no esta encendida con intensidad)
else {
BusData(LUZ3,80);
//printf("%c%c%c%c", 250, LUZ3, 80, LUZ3 + 80); //APAGO
//LuzEstado[3]=80; // Sensor Estar
} //Else
} // If
} // While
Retraso = 0;
...
//LuzEstado[4]=90; // Sensor Cocina
} // si no es 90 (no esta encendida con intensidad)
else {
BusData(LUZ4,80);
//printf("%c%c%c%c", 250, LUZ4, 80, LUZ4 + 80); //APAGO
//LuzEstado[4]=80; // Sensor Cocina
} //Else
} // If
} // While
Retraso = 0;
...
//LuzEstado[5]=90; // Sensor Living
} // si no es 90 (no esta encendida con intensidad)
else {
BusData(LUZ5,80);
//printf("%c%c%c%c", 250, LUZ5, 80, LUZ5 + 80); //APAGO
//LuzEstado[5]=80; // Sensor Living
} //Else
} // If
} // While
Retraso = 0;
...
LEDON;
BusData(184,51);
//printf("%c%c%c%c", 250, 184, 51, 184+51); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
//delay_ms(50);
restart_wdt(); // Reiniciamos el perro
//BusData(184,51);
//printf("%c%c%c%c", 250, 184, 51, 184+51); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
