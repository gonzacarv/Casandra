...
//////////////////////////////Corresponde a MODULO NUMERO 2//////////////////////////////////////////
#define LUZ0 45 // Para modulo 2
#define LUZ1 46 // Para modulo 2
#define LUZ2 47 // Para modulo 2
#define LUZ3 48 // Para modulo 2
#define LUZ4 49 // Para modulo 2
#define LUZ5 50 // Para modulo 2
#define LUZ6 51 // Para modulo 2
#define LUZ7 52 // Para modulo 2
#define LUZ8 53 // Para modulo 2
#define LUZ9 54 // Para modulo 2
#define LUZ10 55 // Para modulo 2
#define LUZ11 56 // Para modulo 2
...
LEDON;
if (input(IN6)) { // SENSORRRRRR!!!!!!!!!!!! pasillo cuartos
BusData(LUZ5,90);
//printf("%c%c%c%c", 250, LUZ5, 90, LUZ5 + 90); //PRENDO
//LuzEstado[5]=90; // Sensor de pasillo
} // si no es 90 (no esta encendida con intensidad)
else {
BusData(LUZ5,80);
//printf("%c%c%c%c", 250, LUZ5, 80, LUZ5 + 80); //APAGO
//LuzEstado[5]=80; // Sensor de pasillo
} //Else
} // If
} // While
Retraso = 0;
...
LEDON;
BusData(184,50);
//printf("%c%c%c%c", 250, 184, 50, 184+50); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
//delay_ms(50);
restart_wdt(); // Reiniciamos el perro
//BusData(184,50);
//printf("%c%c%c%c", 250, 184, 50, 184+50); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
