...
//#define IDD 1    // Identificacion del modulo
...
LEDON;
BusData(29,29);
//printf("%c%c%c%c", 250, 29, 29, 58); //PANICO!!!
} // If
} // While
Retraso = 0;
...
LEDON;
BusData(184,49);
//printf("%c%c%c%c", 250, 184, 49, 184+49); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
//delay_ms(50);
restart_wdt(); // Reiniciamos el perro
//BusData(184,49);
//printf("%c%c%c%c", 250, 184, 49, 184+49); //Identificacion de inicio (49 es 1; 50 es 2; 51 es 3; 52 es 4 y 53 es 5) // Identificacion de red
