...
#use rs232(baud=9600, xmit=PIN_C6, rcv=PIN_C7, enable=PIN_D4) // Comunicacion serial
...
#define OFFLCDLED output_low(PIN_D6)
#define ONLCDLED  output_high(PIN_D6)
...
int LGrupo[99];    // Arreglo que avisa que luz forma parte de los diferentes grupos
...
switch (submenu){
   ...
   case 1: // TODOS
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
      ...
      } // si incierto o prendido
      if (ON[submenu] == 1) { // apagado
      ON[submenu] = 10; // De apagado --> a prendido
      for (kk=32;kk<94;kk++) {
      ...
      printf("%c%c%c%c", 250, 100, 90, 180); // Prendemos todo en la red
      } // si apagado
   break;
   
   case 2: // TODOS INTERIOR // bit 1 de LGrupo
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
   ...
   case 3: // TODOS EXTERIOR // bit 2 de LGrupo
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
   ...
   case 6: // PASILLOS // bit 5 de LGrupo
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
   ...
   case 7: // AUTOMATICO1 // bit 6 de LGrupo
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
   ...
   case 8: // AUTOMATICO2 // bit 7 de LGrupo
      if ((ON[submenu] == 0) || (ON[submenu] == 10)){ // incierto o prendido
      ON[submenu] = 1; // De incierto o prendido --> a apagado
      for (kk=32;kk<94;kk++) {
...
switch (submenu){
   case 1:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo TODAS:       ");
      else printf(lcd_putc, " Grupo      :       ");
      } else printf(lcd_putc, " Grupo TODAS:       ");
   return;

   case 2:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo INTERIOR:    ");
      else printf(lcd_putc, " Grupo         :    ");
      } else printf(lcd_putc, " Grupo INTERIOR:    ");
   return;

   case 3:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo EXTERIOR:    ");
      else printf(lcd_putc, " Grupo         :    ");
      } else printf(lcd_putc, " Grupo EXTERIOR:    ");
   return;

   case 4:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo JARDIN:      ");
      else printf(lcd_putc, " Grupo       :      ");
      } else printf(lcd_putc, " Grupo JARDIN:      ");
   return;

   case 5:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo FRENTE:       ");
      else printf(lcd_putc, " Grupo       :       ");
      } else printf(lcd_putc, " Grupo FRENTE:       ");
   return;

   case 6:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo PASILLOS:       ");
      else printf(lcd_putc, " Grupo         :       ");
      } else printf(lcd_putc, " Grupo PASILLOS:       ");
   return;

   case 7:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo AUTOMATICO 1:   ");
      else printf(lcd_putc, " Grupo             :   ");
      } else printf(lcd_putc, " Grupo AUTOMATICO 1:   ");
   return;

   case 8:
      if (editar == false) {
      if (bit_test(tiempo1,0)) printf(lcd_putc, " Grupo AUTOMATICO 2:   ");
      else printf(lcd_putc, " Grupo             :   ");
      } else printf(lcd_putc, " Grupo AUTOMATICO 2:   ");
   return;
} // switch

lcd_gotoxy(1,4);
if (ON[submenu] == 0) { // si incierto
if (editar){ // editar el grupo encendido
if (bit_test(tiempo1,0)) printf(lcd_putc, "        ???         ");
...
if (ON[submenu] == 1) {
if (editar){ // editar el grupo encendido
if (bit_test(tiempo1,0)) printf(lcd_putc, "       APAGADO      ");
else printf(lcd_putc, "                    ");
...
if (ON[submenu] == 10) {
if (editar){ // editar el grupo encendido
if (bit_test(tiempo1,0)) printf(lcd_putc, "     ENCENDIDO      ");
else printf(lcd_putc, "                    ");
